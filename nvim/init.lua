...
lsp_zero.on_attach(function(client, bufnr)
    ...
    vim.keymap.set("n", "<leader>d", vim.diagnostic.setqflist, opts_desc("Set qflist Diagnostics [LSP]"))
end)
...
vim.keymap.set("n", "<leader>d", builtin.diagnostics, { desc = "Find diagnostics [telescope]" })
